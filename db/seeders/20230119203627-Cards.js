...
module.exports = {
  async up(queryInterface, Sequelize) {
    const cards = [
      ...
      { img: '/img_cards/Загадки/10.jpeg', answer: 'Мягким знаком', question: 'Чем заканчиваются день и ночь?', cost: 10, topic_id: 4 },
      ...
      { img: '/img_cards/Киря/Slon.jpg', answer: 'Одна', question: 'Сколько ног у слона?', cost: 10, topic_id: 5 },
    ]
